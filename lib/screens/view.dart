...
class _LightSensorPageState extends State<LightSensorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_lightIntensity >= 40000) {
      lightLevelDescription = 'Very Bright';
    } else if (_lightIntensity >= 20000) {
      lightLevelDescription = 'Bright';
    } else if (_lightIntensity >= 10000) {
      lightLevelDescription = 'Moderate';
    } else if (_lightIntensity > 0) {
